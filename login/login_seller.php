...
<body>
  <nav class="navbar navbar-expand-md navbar-dark bg-dark">
    ...
    <div class="collapse navbar-collapse" id="navbarCollapse">
        ...
        <div class="navbar-nav ml-auto">
            <a href="../register/register_seller.php" class="nav-item nav-link">Register</a>
  ...
  <div class="jumbotron">
     <div class="text-center">
        <p class="display-4">vendor Login</p>       
     </div>
  </div>
  ...
  <form class="jumbotron m-4" method="POST" action="login_details.php">
    ...
    <button type="submit" name="login_seller" class="btn btn-dark">Sign in</button>
</form>
